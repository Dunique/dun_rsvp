<?php 
 $base_url = BASE.AMP.'C=addons_modules'.AMP.'M=show_module_cp'.AMP.'module=login_backup'.AMP;
?>
...
<h2>Overview</h2>
Entry API is a module that creates a REST/XMLRPC/SOAP server under the hood of the ExpressionEngine CMS. With this module you are capable to select, insert, update and delete entries with a REST, SOAP or XMLRPC call. 
...
This can be download <a href="/system/expressionengine/third_party/entry_api/client_example/documentation.docx">here</a>.
